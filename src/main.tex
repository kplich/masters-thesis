...
\kvpl{rozwój oparty o modele, interfejs użytkownika, ekspresywność, porównanie} % INFO: słowa kluczowe po polsku
\kven{model-driven development, user interface, expressiveness, comparison} % INFO: słowa kluczowe po angielsku
