...
In order to gather \todo{help me here}knowledge and data for the research, a systematic literature review was conducted.
Found \todo{other word?}papers were analyzed with the goal of finding out what features they implement.
...
\todo[inline]{NOTE THAT OPENUIDL IS NOT REALLY ABSTRACT AT THIS POINT (its very influenced by Web dev)}

The results of the study signal the need for further advancement of UI representations; \todo{stroke} even if the gap is narrow and possible to fill, it is still there.
