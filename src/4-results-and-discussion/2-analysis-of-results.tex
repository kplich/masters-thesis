...
% todo: probably i'll have to describe the languages better if i want to draw some conclusions here
...
% todo: maybe describe this more if necessary? like, refer to the requirements and so on?
...
The interface of the application was for the most part intuitive, although sometimes editing the design was not as comfortable as expected. % todo: explain why?
...
OpenUIDL and its platform are much more mature in comparison \textendash\ it is actually a commercialized solution. % todo: expand this?
