...
The representations evaluated in the thesis did not support all features that could be useful in the modern development of UIs.
...
\begin{itemize}
    ...
    \item accessibility\furl{https://developer.mozilla.org/en-US/docs/Web/Accessibility}: an approach to development that takes into account the needs of people with limited abilities
