...
The concept is realized, for example, in the \texttt{<dialog>} element\furl{https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog} defined in the HTML language.
...
such mechanism of replacing the variables or calculations in a string/template with their values is known in some UI technologies as \emph{interpolation}\furl{https://angular.io/guide/interpolation}.
