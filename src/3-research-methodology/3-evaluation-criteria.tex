...
The same mechanism applies to criteria A3.1, A3.2 and, in fact, the criterion \textbf{A3} -- its value is calculated as an average of scores for criteria A3.1 and A3.2.
...
So is the case, too, with events related to the state of an element -- most of them can receive or lose focus, but not only using a mouse, but also e.g.\ using a keyboard or other assistive technologies.
