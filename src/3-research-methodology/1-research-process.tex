...
The defined UI was also implemented (task 3.2.2) using publicly available representations (OpenUIDL~\cite{Moldovan2020}\furl{https://teleporthq.io/}, Quid~\cite{molina2018quid, Molina2019}\furl{https://quid.metadev.pro/}).
The model presented by Verhaeghe et al.~\cite{Verhaeghe2021visual, Verhaeghe2021behavior}\furl{https://github.com/badetitou/Casino} was not used because the model is not available in an easy-to-use form.
