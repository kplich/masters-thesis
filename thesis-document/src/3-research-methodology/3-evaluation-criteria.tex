...
The same mechanism was used to calculate a score for the whole section and for the whole representation.
...
\begin{table}[]
    ...
    \begin{tabular}{||l|l|l|lll|llllllll||}
        ...
        R1  & 77.8\% & \checkmark  & 50.0\%      & \checkmark &            & 83.4\%      & 66.7\% &                 & \checkmark      & \checkmark      & 100.0\% & \checkmark      & \checkmark      \\
        R2  & 47.2\% &             & 100.0\%     & \checkmark & \checkmark & 41.7\%      & 33.3\% & \checkmark      &                 &                 & 50.0\%  & \checkmark      &
    \end{tabular}
\end{table}
