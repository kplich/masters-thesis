...
The tables below concretely name and describe what aspects of UI programming each representation should support;
...
they mostly can be mapped directly to the concepts from the previous section.
...
First two criteria (\textbf{B1} and \textbf{B2}) describe event handling and predefined events that are emitted by predefined elements.
...
% \todo{rewrite finally}A certain representation also included mobile device events, but they were discarded \textendash\ they are outside of UI and closer to client applications;
% other representations do not contain them, so they would skew the results.
...
These two criteria are rather general, because they rather fall in the scope of general client-side programming, not in the scope of UI programming.
...
\begin{longtblr}[
    ...
    \hline[dashed]
    B2.5              & Other events\TblrNote{a}                    & support for other events                                                            \\*
    \hline
    ...
    B10.9             & Others\TblrNote{a}                          & \textemdash                                                                         \\
    \hline
    ...
    \textit{B11.1.13} & \textit{other}\TblrNote{a}                  & \textemdash                                                                         \\*
    \hline[dashed]
    ...
    \textit{B11.2.4}  & \textit{other}\TblrNote{a}                  & \textemdash                                                                         \\*
    \hline[dashed]
    B11.3             & Access operators                            & \textemdash                                                                         \\*
    \textit{B11.3.1}  & \textit{indexing}                           & \textemdash                                                                         \\*
    \textit{B11.3.2}  & \textit{object access}                      & \textemdash                                                                         \\*
    \textit{B11.3.3}  & \textit{other}\TblrNote{a}                  & \textemdash                                                                         \\*
    \hline[dashed]
    B11.4             & Ternary operator                            & \textemdash                                                                         \\
    \hline
...
Table~\ref{tab:evaluation-criteria-components} lists components that might be predefined by the representations' authors.
...
\begin{longtblr}[
    ...
    \hline
    \textbf{D8}  & \textbf{Other properties}\TblrNote{a} & any other properties related to the appearance                                                          \\*
