...
\todo[inline]{unknown vs none \textemdash\ what would be the difference?}
...
\begin{table}[]
    ...
    \begin{threeparttable}[b]
        ...
        \begin{tabularx}{0.8\textwidth}[b]{lrCC}
            ...
            \multirow{2}{*}{\textbf{Supp}}    & tool\tnote{1}  & none                                                  & none                                                 \\
                                               & proc          & none                                                  & a 4-step process for developing a line of UIs        \\
            \multicolumn{2}{l}{\textbf{Avail}}                 & unknown                                               & unknown                                              \\
            \bottomrule
            % @formatter:on
        \end{tabularx}
        \begin{tablenotes}
...
\begin{table}[]
    ...
    \begin{tabularx}{\textwidth}{lrCCC}
        ...
        \multicolumn{2}{l}{\textbf{Expr}}         & low/medium                                        & low (probably)                          & low/medium                                   \\
        \multirow{2}{*}{\textbf{Logic}}    & int  & state, data binding, expressions, events, scripts & events, navigation                      & state, events, scripts                       \\
        ...
        \multirow{2}{*}{\textbf{Supp}}    & tool  & none                                              & none                                    & web editor                                   \\
                                           & proc & none                                              & none                                    & none                                         \\
        \multicolumn{2}{l}{\textbf{Avail}}        & available, open-source                            & unknown                                 & available, closed-source                     \\
        \bottomrule
        % @formatter:on
    \end{tabularx}
\end{table}
...
\begin{table}[]
    ...
    \begin{threeparttable}[b]
        ...
        \begin{tabularx}{\textwidth}{lrCCC}
            % @formatter:off
            \toprule
            \multicolumn{2}{r}{}                      & \textbf{OpenUIDL (2020)}~\cite{moldovan2020open}  & \textbf{XIML (2001)}~\cite{puerta2001ximl} & \textbf{UIML (1999)}~\cite{Abrams1999-ei} \\ \midrule
            \multicolumn{2}{l}{\textbf{Compr}}        & AUI\tnote{1}                                      & T+C                                        & AUI\tnote{2}                              \\
            \multicolumn{2}{l}{\textbf{Expr}}         & medium/high                                       & unknown                                    & low\tnote{2}                              \\
            \multirow{2}{*}{\textbf{Logic}}    & int  & state, events, expressions, navigation            & unknown                                    & events                                    \\
                                               & ext  & none                                              & unknown                                    & UI-backend mappings                       \\
            \multicolumn{2}{l}{\textbf{Gen}}          & SPA                                               & unknown                                    & unknown\tnote{2}                          \\
            \multirow{2}{*}{\textbf{Supp}}     & tool & web editor                                        & unknown                                    & unknown                                   \\
                                               & proc & SPEM disciplines for a development process        & none                                       & none                                      \\
            \multicolumn{2}{l}{\textbf{Avail}}        & available, open source                            & none                                       & available, standardized                   \\
            \bottomrule
            \toprule
            \multicolumn{2}{r}{}                      & & \textbf{MARIA (2009)}~\cite{Paterno2009-nj}  & \textbf{Mueller (2001)}~\cite{Mueller2001-un} \\ \midrule
            \multicolumn{2}{l}{\textbf{Compr}}        & & AUI                                          & AUI                                           \\
            \multicolumn{2}{l}{\textbf{Expr}}         & & unknown\tnote{3}                             & medium/high                                   \\
            \multirow{2}{*}{\textbf{Logic}}    & int  & & events, scripts                              & unknown                                       \\
                                               & ext  & & integration~with~WSDL                        & unknown                                       \\
            \multicolumn{2}{l}{\textbf{Gen}}          & & desktop, HTML, mobile~(legacy)               & desktop, HTML, mobile~(legacy), others        \\
            \multirow{2}{*}{\textbf{Supp}}     & tool & & tool for editing models                      & unknown                                       \\
                                               & proc & & an approach to~\enquote{migratory~UIs}       & part of a broader approach                    \\
            \multicolumn{2}{l}{\textbf{Avail}}        & & scarce                                       & unknown                                       \\
            \bottomrule
            \toprule
            \multicolumn{2}{r}{}                      & \textbf{UsiXML (2004)}~\cite{limbourgusixml,limbourg2004usixml} & \textbf{SUIT (2002)}~\cite{pfistererSemantic2002} & \\ \midrule
            \multicolumn{2}{l}{\textbf{Compr}}        & T+C                                                             & CUI                                               & \\
            \multicolumn{2}{l}{\textbf{Expr}}         & unknown\tnote{3}                                                & medium                                            & \\
            \multirow{2}{*}{\textbf{Logic}}    & int  & events, actions, navigation                                     & state, data binding, expressions, events, actions & \\
                                               & ext  & unknown\tnote{3}                                                & support for a remote communication protocol       & \\
            \multicolumn{2}{l}{\textbf{Gen}}          & HTML, others                                                    & desktop\tnote{3}                                  & \\
            \multirow{2}{*}{\textbf{Supp}}     & tool & a set of various tools                                          & none                                              & \\
                                               & proc & none                                                            & none                                              & \\
            \multicolumn{2}{l}{\textbf{Avail}}        & scarce resources available                                      & unknown                                           & \\
            \bottomrule
            % @formatter:on
        \end{tabularx}
        \begin{tablenotes}
    ...
    \centering
        \begin{threeparttable}[b]
            ...
            \begin{tabularx}{0.8\textwidth}[b]{lrCC}
                ...
                \multirow{2}{*}{\textbf{Logic}\tnote{1}} & int           & none                                                    & events                                             \\
                                                         & ext           & none                                                    & none                                               \\
                \multicolumn{2}{l}{\textbf{Gen}}                         & none                                                    & desktop                                            \\
                \multirow{2}{*}{\textbf{Supp}}          & tool\tnote{2}  & none                                                    & none                                               \\
                                                         & proc          & none                                                    & none                                               \\
